...
//  Waddit
//
//  Created by Uiseop Eom on 2022/01/27.
//
...
extension UIView {
    ...
    @discardableResult
    open func fillSuperviewWidth(padding: UIEdgeInsets = .zero) -> AnchoredConstraints {
        translatesAutoresizingMaskIntoConstraints = false
        let anchoredConstraints = AnchoredConstraints()
        ...
        return anchor(top: nil, leading: superviewLeadingAnchor,
                      bottom: nil, trailing: superviewTrailingAnchor, padding: padding)
    }
    ...
    open func centerXToSuperview(constant: CGFloat) {
        translatesAutoresizingMaskIntoConstraints = false
        if let superviewCenterXAnchor = superview?.centerXAnchor {
