...
class BaseFeedViewController: TabmanViewController {
    ...
    func addSideButton() {
        ...
        sideButton.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: -15).isActive = true
    ...
    func addSearchButton() {
        ...
        searchButton.topAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.topAnchor, constant: -5).isActive = true
